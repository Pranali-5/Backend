...
import { ProjectDataCard } from "./ProjectCardData";
...
export const Home = () => {
    return (
        <div>
                    ...
                    <div className="row">
                        <div className="col-12 mx-auto">
                            <div className="row">
                                ...
                                <h1 className="myInfo">Hi there, I'm Pranali <img  className="hi" src="https://blog.joypixels.com/content/images/2019/06/woman_raising_hand_1024.gif" alt=""></img> </h1>
                                <br />
                                <h3>A Full Stack Developer who is Dedicated and honest with her work and believes in hardwork.
                                    Love to accept challenges and work on them with full dedication which leads to strong in skills
                                    more and having experiences in collaborative projects with good team communication.</h3>
            ...
            <div className="col-lg-12 order-1 order-lg-2">
                <h1 className="project_title">Skills</h1>
            ...
            <br />
            <br/>
            <div className="❤️">Made with ❤️ by Pranali Malkar</div>
            <br />
        </div>
    )
}
